...
from pandas import HDFStore, DataFrame, read_csv
from numpy import load

path.append(".")
from src.utils.io import load_config
from src.ml.feature_selection_nested_loso import run_same_side_classifications, run_opposite_side_prediction
...
def main():
    path_to_config: str = "src/run/feature_selection/config_nested_loso.yml"
