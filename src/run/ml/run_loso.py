...
from src.ml.loso import run_same_side_classifications, run_opposite_side_prediction

basicConfig(filename="logs/run_loso.log", level=DEBUG)

logger = getLogger("main")


def main():
    path_to_config: str = "src/run/ml/config_loso.yml"
